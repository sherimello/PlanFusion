...
class BookingFormRoyalPalace extends StatefulWidget {
  @override
  State<BookingFormRoyalPalace> createState() => _BookingFormRoyalPalaceState();
}

class _BookingFormRoyalPalaceState extends State<BookingFormRoyalPalace> {
