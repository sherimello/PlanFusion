...
class BookingFormMajesty extends StatefulWidget {
  @override
  State<BookingFormMajesty> createState() => _BookingFormMajestyState();
}

class _BookingFormMajestyState extends State<BookingFormMajesty> {
