...
class BookingFormDiamond extends StatefulWidget {
  @override
  State<BookingFormDiamond> createState() => _BookingFormDiamondState();
}

class _BookingFormDiamondState extends State<BookingFormDiamond> {
