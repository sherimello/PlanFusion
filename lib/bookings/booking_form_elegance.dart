...
class BookingFormElegance extends StatefulWidget {
  @override
  State<BookingFormElegance> createState() => _BookingFormEleganceState();
}

class _BookingFormEleganceState extends State<BookingFormElegance> {
