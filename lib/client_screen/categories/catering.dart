...
class CateringScreenState extends State<CateringScreen> {
  ...
  final List<String> cateringNames = [
    "Wedding Catering",
    "Corporate Catering",
    "Birthday Catering",
    "Party Catering",
  ...
  final List<String> cateringDescriptions = [
    "Perfect for your big day, serving gourmet wedding meals.",
    "Professional catering for business events and conferences.",
    "Catering that will make your birthday party a hit.",
    "Fun and creative catering for your next party.",
    "Simple and delicious catering for everyday events.",
    "Lavish buffet catering for a large group of guests."
  ];

  final List<String> cateringImages = List.generate(6, (index) => 'assets/catering1.jpg');

  final List<String> originalPrices = List.generate(6, (index) => "PKR ${index * 2500 + 7000}");
  final List<double> discounts = [0.1, 0.3, 0.5, 0.2, 0.4, 0.6];

  late List<String> filteredCateringNames;
  late List<String> filteredCateringDescriptions;
  late List<String> filteredCateringImages;
  ...
  void initState() {
    ...
    filteredCateringNames = List.from(cateringNames);
    filteredCateringDescriptions = List.from(cateringDescriptions);
    filteredCateringImages = List.from(cateringImages);
    filteredOriginalPrices = List.from(originalPrices);
    filteredDiscountPrices = List.generate(
      6,
          (index) => "PKR ${((1 - discounts[index]) * (index * 2500 + 7000)).toStringAsFixed(0)}",
    );
  }

  void filterCateringServices(String query) {
    setState(() {
      filteredCateringNames = cateringNames
          .where((name) => name.toLowerCase().contains(query.toLowerCase()))
          .toList();
      filteredCateringDescriptions = cateringDescriptions
            ...
            child: Material(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  onChanged: filterCateringServices,
                  decoration: InputDecoration(
                    hintText: "Search Catering Services...",
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where("category", isEqualTo: "Catering")
                    .snapshots(),
